      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="col-xl-3 col-md-6 mb-4">
             ...
             <?php 
$query1=mysqli_query($conn,"SELECT * from tblstudentenroll 
join tblstudents on tblstudentenroll.SRegNumber=tblstudents.RegNumber 
              ...
              <div class="card h-100">
                <div class="card-body" style="background-color:#9fc1f5 ;color:#080808;border-radius:10px">
                  <div class="row align-items-center" >
                    <div class="col mr-2" >
                      <div class="text-xs font-weight-bold text-uppercase mb-1" style="font-size:14px">Enrolled Courses</div>
