...
<?php 
  ...
  $query = "SELECT * FROM tblstudents WHERE RegNumber = '$reg'";
  $rs = $conn->query($query);
  $num = $rs->num_rows;
  $rows = $rs->fetch_assoc();
  $fullName = $rows['firstName']." ".$rows['lastName']." ( ".$rows['RegNumber']." )";

?>
<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top bg-gradient-primary" style="height: 100px;" >
          ...
          <ul class="navbar-nav ml-auto">  
            ...
            <li class="dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <i class="fas fa-key fa-fw mr-2 text-danger"></i>
                  Change Password
                </a>
              </div>
            </li>
